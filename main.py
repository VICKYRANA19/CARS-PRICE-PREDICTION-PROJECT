...
def index():
    ...
    return render_template('index (1).html', company=companies, car_model=cars_models, years=year, fuel_Type=fuel_types, transmission =transmissions, owner=owners , registration=registration ,state=state ,seating_capacity=seating_capacity,city=city)
